...
public class PagoRepositoryImpl extends JdbcDaoSupport implements PagoRepository {
    ...
    @Override
    public int insertarCabeceraBoleta(OrdenPagoResponse ordenPagoResponse) {
